[
  ...
  },
  {
    ...
    Answers: [
      ...
      { Id: 102336, Text: "UDDI tương tự như WSDL" },
      {
        Id: 102337,
        Text:
          "UDDI cho phép ghi thông tin về doanh nghiệp và chi tiết sử dụng dịch vụ web."
      },
      {
        Id: 102338,
        Text:
          "UDDI không cho phép ghi thông tin về doanh nghiệp và chi tiết sử dụng dịch vụ web, nó chỉ được thực hiện qua WSDL"
      }
    ]
  },
  {
    ...
    Answers: [
      ...
      },
      {
        Id: 102340,
        Text:
          "WSDL kết nối trực tiếp với cơ sở dữ liệu SQLite và trả về kết quả cho người dùng"
      },
  ...
  },
  {
    ...
    Answers: [
      ...
      { Id: 102352, Text: "API bản chất là một webserver" },
      {
        Id: 102353,
        Text:
          "Để giao tiếp các chương trình sử dụng API nhất thiết phải có sự tham gia của người dùng"
      },
  ...
  },
  {
    ...
    Answers: [
      ...
      { Id: 102360, Text: "API là một file thực thi dạng exe" },
      {
        Id: 102361,
        Text:
          "API không cho phép các nhà phát triển khác sử dụng để phát triển sản phẩm của riêng họ"
      },
      {
        Id: 102362,
        Text:
    ...
    Answers: [
      {
        Id: 102367,
        Text:
          "Có thể hiển thị lịch sử truy cập nhưng tối đa hiển thị là 10 bản ghi"
      },
    ...
    Answers: [
      {
        Id: 102383,
        Text:
          "Live Framework là một thư mục chia sẻ, tương tác với các thành phần trong hệ điều hành"
      },
      {
        Id: 102384,
        Text:
          "Live Framework là một API cho phép truy cập các dịch vụ Live Mesh trên HTTP"
      },
    ...
    Answers: [
      {
        Id: 102395,
        Text:
          "Là dịch vụ hỗ trợ truy xuất dữ liệu trên cloud nhưng không hỗ trợ lưu trữ"
      },
  ...
  },
  {
    ...
    Answers: [
      ...
      },
      {
        Id: 102433,
        Text:
          "Chỉ càn quản lý phần mềm đang chạy, không cần quản lý cơ sở hạ tầng"
      },
      {
        Id: 102434,
        Text:
          "Chỉ cần quản lý có sở hạ tầng, không cần quản lý phần mềm đang chạy"
      }
    ]
  },
  {
  ...
  },
  {
    Id: 24688,
    Text:
      "Google Apps Premier Edition hỗ trợ cho mỗi user miễn phí bao nhiêu GB?",
    Marks: 1,
    AnswerId: 102439,
    Answers: [
      { Id: 102439, Text: "10GB" },
  ...
  },
  {
    ...
    Answers: [
      ...
      { Id: 102444, Text: "Là một dịch vụ lưu trữ trên một máy client" },
      {
        Id: 102445,
        Text:
          "Là một ứng dụng lưu trữ trên một máy chủ từ xa và truy cập thông qua Internet"
      },
    ...
    Answers: [
      {
        Id: 102447,
        Text:
          "Google Apps Google Apps Premier Edition, Google List, Google Collection"
      },
      {
        Id: 102448,
  ...
  },
  {
    ...
    Answers: [
      ...
      },
      {
        Id: 102464,
        Text:
          "Tích hợp tự động các dịch vụ web (SOAP / REST) ​​và cơ sở dữ liệu (Oracle, ASP.NET)"
      },
      {
        Id: 102465,
        Text:
          "Tích hợp tự động các dịch vụ web (SOAP / REST) ​​và cơ sở dữ liệu (MySQL / PostgreSQL)"
      },
    ...
    Answers: [
      {
        Id: 102483,
        Text:
          "Cho phép các thành viên sử dụng chuyên môn để tạo ra các ứng dụng phục vụ cho những người có chuyên môn kỹ thuật"
      },
      {
        Id: 102484,
        Text:
          "Cho phép các thành viên có chuyên môn tạo nên ứng dụng để phục vụ chính họ"
      },
      {
        Id: 102485,
        Text:
          "Cho phép các thành viên để tạo ra các ứng dụng phục vụ cho những người không có chuyên môn kỹ thuật"
      },
      {
        Id: 102486,
    ...
    Answers: [
      {
        Id: 102495,
        Text:
          "Một nền tảng để chạy bất cứ ứng dụng nào trong các đám mây mà không cần phải lo lắng về phần cứng, phần mềm và mạng"
      },
      {
        Id: 102496,
        Text:
          "Là một thành phần của Microsoft Azure, cho phép tải các ứng dụng lên đám mây của Microsoft"
      },
  ...
  },
  {
    ...
    Answers: [
      { Id: 102519, Text: "Ứng dụng web" },
      {
        Id: 102520,
        Text:
          "Không cho phép tạo ứng dụng của riêng bạn mà chỉ cho phép bạn sử dụng"
      },
  ...
  },
  {
    Id: 24709,
    Text:
      "DevOps Services là dịch vụ của thành phần nào trong các thành phần sau?",
    Marks: 1,
    AnswerId: 102525,
    Answers: [
